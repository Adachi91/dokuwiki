...
<body>
    ...
    <nav class="navbar has-shadow is-link mb-4" role="navigation" aria-label="main navigation">
            <div class="navbar-brand">
                <!-- LOGO -->
                <?php
                    $logo = tpl_getMediaFile(array('images/logo.svg'), false); /* Adachi_ The author used absolute pathing leading to conical url pathing + base pathing fqdn///fqdn/img/img.ext */
                    tpl_link(
                        wl(),
                        '<img src="'. $logo .'"  alt="" />',
